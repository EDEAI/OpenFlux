...
import { describeToolAction, describeToolCommand } from '../runtime/activity-descriptor';
...
export interface OpenFluxChatProgressEvent {
    ...
    token?: string;
    description?: string;
    toolCalls?: Array<{ id: string; name: string; title?: string; command?: string }>;
        ...
        switch (cmd) {
            ...
            case 'MCPTOOLUSE':
                ...
                onProgress({
                    ...
                    toolCalls: [{
                        id: data?.id != null ? String(data.id) : randomUUID(),
                        name: data?.name || 'mcp_tool',
                        title: describeToolAction(data?.name || 'mcp_tool', data?.args || data, 'zh'),
                        command: describeToolCommand(data?.name || 'mcp_tool', data?.args || data),
                    }],
                });
                break;
