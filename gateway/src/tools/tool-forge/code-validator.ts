/**
 * Code Validator
 * Perform static security verification on tool code generated by Agent (AST analysis + blacklist detection)
 * Instead of using a sandbox, verify code security before execution
 */
...
export interface ValidationResult {
    /** Verification status: PASS=Safe, WARN=Risky but executable, BLOCK=Contains dangerous operations */
    status: 'PASS' | 'WARN' | 'BLOCK';
    /** Issues found */
    issues: ValidationIssue[];
    /** Non-technical language summary displayed during manual confirmation */
    humanSummary: string;
}
...
/** File system operation blacklist */
...
/** Privilege escalation blacklist */
...
// BLOCK level (direct interception)
...
export function validateCode(code: string, scriptType: 'python' | 'node' | 'shell'): ValidationResult {
    ...
    // Generate a human-readable summary (non-technical language)
...
/**
 * Generate security summaries in non-technical language
 * Confirmation prompts for non-technical users as required by the plan
 */
