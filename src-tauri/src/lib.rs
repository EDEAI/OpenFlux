...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::browser_view::browser_view_frames,
            ...
            commands::browser_view::browser_view_set_download_dir,
            ...
            commands::chrome_extension::chrome_extension_path,
            commands::chrome_extension::chrome_extension_open_settings,
